{lib, osConfig, pkgs, inputs, ...}:{
  wayland.windowManager.sway = {
    ...
    startup = [
      { command = "waybar"; }
      (lib.mkIf (osConfig.networking.hostName == "Nomad") ({ command = "swaybg -m fill -i ~/.config/nixos/images/halftone-purple.png"; }))
      (lib.mkIf (osConfig.networking.hostName == "Absolution") ({command = "swaybg -m fill -i ~/.config/nixos/images/birb.png"; }))
      { command = "swaync"; }
